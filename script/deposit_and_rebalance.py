...
def moccasin_main():
    ...
    print("")
    print("USDC balance: ", usdc.balanceOf(boa.env.eoa))
    print("WETH balance: ", weth.balanceOf(boa.env.eoa))
    print("aUSDC balance: ", a_usdc.balanceOf(boa.env.eoa))
    print("aWETH balance: ", a_weth.balanceOf(boa.env.eoa))
