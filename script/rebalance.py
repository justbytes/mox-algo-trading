...
def check_for_rebalance() -> bool:
    print("")
    print("Checking if rebalance is needed...")
    ...
    return needs_rebalancing, a_usdc_balance_normalized, a_weth_balance_normalized


def rebalance(
    usdc: ABIContract, weth: ABIContract, a_usdc: ABIContract, a_weth: ABIContract
):
    needs_rebalance, a_usdc_balance_normalized, a_weth_balance_normalized = check_for_rebalance()
